        ...
        <form @submit.prevent="submit">
            <div class="space-y-5">
                ...
                <div>
                    <div class="flex justify-between items-center mb-1.5 ml-1">
                        ...
                        <Link v-if="canResetPassword" :href="route('password.request')" class="text-xs font-bold text-[#2DD4BF] hover:text-[#14B8A6]">
                            Forgot?
                        </Link>
                    </div>
                    <TextInput
            ...
            <div class="mt-6 flex items-center ml-1">
                <label class="flex items-center cursor-pointer group">
                    <Checkbox name="remember" v-model:checked="form.remember" class="rounded-lg border-gray-300 text-[#2DD4BF] focus:ring-[#2DD4BF]" />
                    <span class="ms-3 text-sm text-gray-500 group-hover:text-gray-700 transition">Keep me logged in</span>
                </label>
            </div>
