...
const sendMesinEmail = (item) => {
    if (!confirm(`Kirim daftar mesin ke email vendor ${item.nama_vendor}?`)) return;

    router.post(route('master-vendor.send-mesin-email', item.id), {}, {
        preserveScroll: true,
    });
};
                                ...
                                <tr v-for="item in vendors.data" :key="item.id"
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end items-center gap-2">
                                            <button
                                                @click="sendMesinEmail(item)"
                                                class="inline-flex items-center gap-1 px-3 py-2 text-[10px] font-black uppercase tracking-widest text-blue-600 bg-blue-50 rounded-xl hover:bg-blue-500 hover:text-white transition-all"
                                                title="Kirim Email Mesin"
                                            >
                                                Email
                                            </button>
                                            ...
                                            <button
                                                @click="openEdit(item)"
                                                class="inline-flex items-center gap-1 px-3 py-2 text-[10px] font-black uppercase tracking-widest text-[#2DD4BF] bg-[#2DD4BF]/5 rounded-xl hover:bg-[#2DD4BF] hover:text-white transition-all"
                                            >
                                                Edit
                                            </button>
                                            ...
                                            <button
                                                ...
                                                class="inline-flex items-center gap-1 px-3 py-2 text-[10px] font-black uppercase tracking-widest text-rose-500 bg-rose-50 rounded-xl hover:bg-rose-500 hover:text-white transition-all"
                                            >
                                                Hapus
                                            </button>
                                        </div>
