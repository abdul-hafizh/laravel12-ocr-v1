        ...
        <div class="space-y-6">
            <div class="bg-white rounded-[2rem] border border-slate-200 p-8 shadow-sm">
                ...
                <p class="mt-2 text-sm text-slate-500 max-w-2xl">
                    Gunakan dashboard ini untuk melihat ringkasan data utama seperti cabang,
                    mesin, dan user aktif yang terdaftar pada sistem.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                    <div class="flex items-start justify-between">
                        ...
                        <div class="w-12 h-12 rounded-2xl bg-[#2DD4BF]/10 flex items-center justify-center text-2xl">
                            {{ card.icon }}
                        </div>
                    </div>
